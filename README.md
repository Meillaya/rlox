...
Possible improvements to the interpreter:
- Better performance through bytecode compilation
- REPL (Read-Eval-Print Loop) for interactive use
- Standard library of built-in functions
- Additional language features (like modules, array types, etc.)
